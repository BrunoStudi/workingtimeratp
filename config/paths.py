...
# ========= Création & configuration des dossiers =========
...
DEPANNAGE_NETWORK_FILE = Path(r"S:\EK1\03-PARTAGE\AME\depannage.json")
DEPANNAGE_NETWORK_IMAGES_DIR = Path(r"S:\EK1\03-PARTAGE\AME\wtratp_pictures")
